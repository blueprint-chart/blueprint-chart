<template>
  <div class="d-flex flex-column gap-3">
    <FormControlCheckbox
      v-if="hasSwapAxes"
      :model-value="currentOptions.swapAxes ?? false"
      label="Swap axes"
      @update:model-value="(v) => setOption('swapAxes', v)"
    />
...
const hasSwapAxes = computed(() => availableOptionKeys.value.includes('swapAxes'))
