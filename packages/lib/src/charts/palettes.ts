...
const PALETTES: PaletteEntry[] = [
  ...
  { name: 'Cancri', label: 'Cancri', colors: ['#343854', '#8c384d', '#c9002e', '#d95e31', '#f0c742', '#f8f0e5'] },
  ...
  { name: 'Deathmasks', label: 'Deathmasks', colors: ['#926159', '#94947b', '#c7d2d8', '#62b7c8', '#43535c', '#23313c'] },
  ...
  { name: 'X10', label: 'Dusk', colors: ['#2a2432', '#5b4361', '#846d86', '#efefcf', '#e3c58a', '#a89e5e'] },
  ...
  { name: 'X115', label: 'Sienna', colors: ['#001a29', '#633633', '#8e442e', '#e9b35e', '#eee6a6'] },
