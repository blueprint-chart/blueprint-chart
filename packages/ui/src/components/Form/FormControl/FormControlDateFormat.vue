...
.form-control-date-format__popover {
  font-size: 0.8125rem;
}

.form-control-date-format__list {
  display: flex;
  flex-direction: column;
}

.form-control-date-format__item {
  display: flex;
  align-items: center;
...
.form-control-date-format__item-body {
  flex: 1;
  min-width: 0;
}
...
.form-control-date-format__item-check {
  color: var(--bs-primary);
  font-size: 0.75rem;
  flex-shrink: 0;
}

.form-control-date-format__custom {
  padding: 0.625rem;
  border-top: 1px solid var(--bs-border-color);
}

.form-control-date-format__section-label {
  font-size: 0.625rem;
  font-weight: 600;
...
.form-control-date-format__input {
  width: 100%;
  height: 1.75rem;
  padding: 0 0.5rem;
...
.form-control-date-format__custom-preview {
  margin-top: 0.375rem;
  font-size: 0.6875rem;
  color: var(--bs-secondary-color);
}

.form-control-date-format__custom-preview-value {
  font-family: var(--bs-font-monospace);
  color: var(--bs-body-color);
}
</style>
