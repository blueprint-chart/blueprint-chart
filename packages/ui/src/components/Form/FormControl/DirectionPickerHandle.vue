...
.direction-picker-handle {
  ...
  // Positions
  &[data-d="nw"] { top: 0; left: 0; }
  &[data-d="n"]  { top: 0; left: 50%; }
  &[data-d="ne"] { top: 0; left: 100%; }
  &[data-d="w"]  { top: 50%; left: 0; }
  &[data-d="c"]  { top: 50%; left: 50%; }
  &[data-d="e"]  { top: 50%; left: 100%; }
  &[data-d="sw"] { top: 100%; left: 0; }
  &[data-d="s"]  { top: 100%; left: 50%; }
  &[data-d="se"] { top: 100%; left: 100%; }
}
</style>
